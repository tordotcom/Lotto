            ...
            for (var i = 0; i < Object.keys(data).length; i++) {
                ...
                if (parseInt(data[i].Result_Status) > 0) {
                    htmlString += '<div class="row bet-cell">' +
                        ...
                        '<div class="col-xs-3 bet-lotto"><input style="background-color:lightgreen" id="' + lotto_id + '" type="text" maxlength="3" class="form-control form-control-sm input-color" placeholder="" disabled onchange="checkNumber(' + (i + 1) + ')" onkeypress="return keyPress2(this,' + (i + 1)+' , event);" value="' + data[i].Number + '"></div>' +
